...
<body>
	...
	<div class="container">
		<form action="../../controller/board_write_controller.jsp"
			...
			제목 : <input type="text" name="title" class="form-control"> <br> 내용 :
			<textarea rows="10" cols="50" name="content" class="form-control"></textarea>
			<br> 첨부파일 : <input type="file" name="file" class="form-control"> <br> <input
				type="submit" value="등록" class="form-control btn btn-success">
